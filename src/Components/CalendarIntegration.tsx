  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-zinc-900">
      <div className="p-6">
        ...
        {/* Show helper message when no location is set */}
        {!hasLocation && (
        ...
        {/* Calendar integration buttons - only show when location is set */}
        {hasLocation && (
          <>
        ...
        {/* Manual section toggle - only show when location is set */}
        {hasLocation && (
          <>
            <div className="mt-6">
              <button
