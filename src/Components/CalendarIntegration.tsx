    ...
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-zinc-900">
      ...
      {!hasLocation && (
        <div className="mb-4 flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
          <MapPinIcon className="mt-0.5 h-5 w-5 shrink-0 text-amber-600 dark:text-amber-400" />
          <div className="text-sm">
            <p className="font-medium text-amber-800 dark:text-amber-200">{translations[lang].enterLocationTitle}</p>
            <p className="mt-1 text-amber-700 dark:text-amber-300">{translations[lang].enterLocationDescription}</p>
          </div>
        </div>
      )}
      ...
      {hasLocation && !hasValidationErrors && (
        <>
          ...
          <div className="mt-6">
            ...
            >
              <span className="text-amber-600 dark:text-amber-400">{translations[lang].manualInstructions}</span>
              ...
              <div>
                ...
                <div className="flex rounded-md shadow-sm">
                  <input
                    ...
                    readOnly
                    value={link}
                    className="block w-full min-w-0 flex-1 rounded-none rounded-l-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-500 dark:border-gray-600 dark:bg-zinc-700 dark:text-gray-400"
                  />
                  <button
                    type="button"
                    onClick={handleCopy}
